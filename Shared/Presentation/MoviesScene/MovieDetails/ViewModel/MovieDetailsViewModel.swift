...
protocol MovieDetailsViewModelProtocol: MovieDetailsViewModelInput, MovieDetailsViewModelOutput { }

final class MovieDetailsViewModel: MovieDetailsViewModelProtocol {
    
    private let posterImagePath: String?
    private let posterImagesRepository: PosterImagesRepositoryProtocol
    ...
    init(movie: MovieEntity,
         posterImagesRepository: PosterImagesRepositoryProtocol) {
